...
export const queryKeys = {
  ...
  companies: {
    ...
    userCompany: (userId: number) =>
      [...queryKeys.companies.all, "userCompany", userId] as const,
  },
  ...
  positions: {
    ...
    byCompany: (companyId: number) =>
      [...queryKeys.positions.all, "byCompany", companyId] as const,
  },
  ...
  applicants: {
    ...
    byCompany: (companyId: number) =>
      [...queryKeys.applicants.all, "byCompany", companyId] as const,
  },
  ...
  applications: {
    ...
    byPosition: (positionId: number) =>
      [...queryKeys.applications.all, "byPosition", positionId] as const,
    byApplicant: (applicantId: number) =>
      [...queryKeys.applications.all, "byApplicant", applicantId] as const,
  },
  ...
  moreworks: {
    all: ["moreworks"] as const,
    lists: () => [...queryKeys.moreworks.all, "list"] as const,
    list: (filters: Record<string, any>) =>
      [...queryKeys.moreworks.lists(), { filters }] as const,
  },
} as const;
